...
export class migrations1676929394312 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."favs_type_enum" AS ENUM('artist', 'album', 'track')`,
    );
    await queryRunner.query(
      `CREATE TABLE "favs" ("id" character varying NOT NULL, "type" "public"."favs_type_enum" NOT NULL, "trackId" uuid, "artistId" uuid, "albumId" uuid, CONSTRAINT "PK_2fde25c80bd089c0fa0e7986409" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
